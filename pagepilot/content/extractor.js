...
function showPopup(text) {
  ...
  el.id = 'pp-popup';
  el.innerHTML = `<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;"><strong>🔍 PagePilot</strong><button onclick="this.closest('#pp-popup').remove()" style="background:none;border:none;color:#fff;cursor:pointer;font-size:16px;">✕</button></div><div style="font-size:13px;line-height:1.6;color:rgba(255,255,255,0.8);">${text}</div>`;
