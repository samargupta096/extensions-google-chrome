  ...
  visibilityContainer.innerHTML = `
    ...
    <div id="visibility-panel" class="visibility-panel">
      ...
      <div class="visibility-list">
        ...
        <label draggable="true"><span class="list-drag-handle">⠿</span><input type="checkbox" value="extmonitor" checked> Extension Monitor</label>
